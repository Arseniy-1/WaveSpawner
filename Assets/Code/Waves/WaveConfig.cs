...
namespace Code.Waves
{
    ...
    {
        [SerializeField] private List<ObjectWeightPair<Enemy.Enemy>> _enemiesWeights;
        [SerializeField] private Enemy.Enemy _boss;
        ...
        public IReadOnlyList<ObjectWeightPair<Enemy.Enemy>> EnemyWeights => _enemiesWeights;
        public Enemy.Enemy Boss => _boss;
